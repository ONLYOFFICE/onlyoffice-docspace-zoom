...
namespace ASC.ApiSystem.Helpers;

[Scope]
public class ZoomAccountHelper
{
    private readonly ZoomLoginProvider _zoomLoginProvider;
    private readonly AccountLinker _accountLinker;
    private readonly UserManager _userManager;

    public ZoomAccountHelper(ConsumerFactory consumerFactory, AccountLinker accountLinker, UserManager userManager)
    {
    ...
    public ZoomLoginProvider GetLoginProvider()
    {
