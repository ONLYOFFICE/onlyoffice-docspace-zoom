...
using ASC.ZoomService.Services.NotifyService;
...
public class NotifySource : NotifySourceBase
{
    public NotifySource(UserManager userManager, IRecipientProvider recipientsProvider, SubscriptionManager subscriptionManager, TenantManager tenantManager)
        : base(new Guid("73A767FB-E4A9-4A40-AB87-65C6C3BCCE81"), userManager, recipientsProvider, subscriptionManager, tenantManager)
    {
    }

    protected override IActionProvider CreateActionProvider()
    {
        return new ConstActionProvider(NotifyConstants.ZoomWelcome);
    }

    protected override IPatternProvider CreatePatternsProvider()
    {
        return new XmlPatternProvider2(ZoomPatternResource.patterns);
    }
}
